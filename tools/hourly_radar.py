...
def render_index(groups: dict[str, list[dict[str, Any]]], new_count: int) -> None:
    ...
    text = f"""<!doctype html><html lang=\"ru\">{head('News Dispatch — Live Radar', 'Ежечасный радар по тематическим потокам.')}<body><header class=\"masthead compact radar-hero\"><a class=\"backlink\" href=\"../index.html\">News Dispatch</a><p class=\"eyebrow\">Live Radar</p><h1>Ежечасный радар</h1><p class=\"lede\">Свежие публичные сигналы по зонам интереса. Это не аналитический выпуск, а быстрая карта того, что появилось в источниках.</p><nav class=\"hero-actions\" aria-label=\"Навигация\"><a href=\"../streams/index.html\">Потоки</a><a href=\"../dispatches.html\">Выпуски</a><a href=\"../rss.xml\">RSS</a></nav><p class=\"radar-status\">Обновлено: {html.escape(updated)} · новых сигналов в запуске: {new_count}</p></header><main class=\"radar-layout\">{''.join(blocks)}</main></body></html>"""
