...
- **Tether's USDT jumps to 8.5% premium in India after crypto payment crackdown**
  ...
  - Signal path: `signals/2026-06-29/crypto-finance/81a407eb6fb2ae0b-tether-s-usdt-jumps-to-8-5-premium-in-india-after-crypto-payment-crackdo.md`
...
- **Nike Floods The Air Force 1 Low With “Fire Pink”**
  - Topic: `ai-platforms`
  - Source: `sneaker-news` / `specialized_media`
  - Signal path: `signals/2026-06-29/gear-style-edc/f2f4f09129308e9f-nike-floods-the-air-force-1-low-with-fire-pink.md`
  - Confirmation: source-reported RSS/Atom appearance.
  - Editorial status: needs grouping, context check and impact assessment.
...
- **South Korea to spend $1T on more memory chip production and humanoid robots**
  ...
  - Signal path: `signals/2026-06-29/tech-hardware-software/0c22bcce83de4978-south-korea-to-spend-1t-on-more-memory-chip-production-and-humanoid-robo.md`
  - Confirmation: source-reported RSS/Atom appearance.
  - Editorial status: needs grouping, context check and impact assessment.
