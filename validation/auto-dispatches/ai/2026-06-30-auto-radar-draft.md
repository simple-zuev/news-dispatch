...
sources:
  - "https://3dnews.ru/1144308"
source_titles:
  - "3DNews: OpenAI мельком продемонстрировала ИИ-устройство, связанное с моделью Codex"
source_types:
...
1. OpenAI мельком продемонстрировала ИИ-устройство, связанное с моделью Codex — сообщение источника «3DNews: OpenAI мельком продемонстрировала ИИ-устройство, связанное с моделью Codex»; требует проверки перед выводами.

## Что произошло

- OpenAI мельком продемонстрировала ИИ-устройство, связанное с моделью Codex. Источник: 3DNews: OpenAI мельком продемонстрировала ИИ-устройство, связанное с моделью Codex. URL: https://3dnews.ru/1144308
...
|---|---|---|---|---|
| OpenAI мельком продемонстрировала ИИ-устройство, связанное с моделью Codex | source_reported_claim | 3DNews: OpenAI мельком продемонстрировала ИИ-устройство, связанное с моделью Codex | medium | Первичный источник, дата, статус, контекст и независимые подтверждения. |
