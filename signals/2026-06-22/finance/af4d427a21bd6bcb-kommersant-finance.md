---
title: "РБК: ЦБ не разрешил трем банкам создать альтернативную платежную систему"
date: "2026-06-22"
status: "draft"
signal_type: "fact"
...
sources:
  - "https://www.kommersant.ru/doc/8761669"
source_titles:
  - "Коммерсантъ: РБК: ЦБ не разрешил трем банкам создать альтернативную платежную систему"
source_types:
  - "Деловое медиа"
media:
  - "https://www.kommersant.ru/doc/8761669"
...
# РБК: ЦБ не разрешил трем банкам создать альтернативную платежную систему
...
- Заголовок: РБК: ЦБ не разрешил трем банкам создать альтернативную платежную систему.
