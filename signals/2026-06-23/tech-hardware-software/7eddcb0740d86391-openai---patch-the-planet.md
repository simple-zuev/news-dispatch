---
title: "OpenAI запустила инициативу Patch the Planet, чтобы помочь разработчикам открытого ПО в поиске ошибок"
date: "2026-06-23"
status: "draft"
signal_type: "fact"
...
sources:
  - "https://3dnews.ru/1143951"
source_titles:
  - "3DNews: OpenAI запустила инициативу Patch the Planet, чтобы помочь разработчикам открытого ПО в поиске ошибок"
source_types:
...
- Заголовок: OpenAI запустила инициативу Patch the Planet, чтобы помочь разработчикам открытого ПО в поиске ошибок.
