---
title: "«Не можем создать смартфон», — Nothing отменила выпуск CMF Phone 3 Pro из-за роста цен на память"
date: "2026-06-19"
status: "draft"
signal_type: "fact"
...
sources:
  - "https://3dnews.ru/1143833"
source_titles:
  - "3DNews: «Не можем создать смартфон», — Nothing отменила выпуск CMF Phone 3 Pro из-за роста цен на память"
source_types:
...
- Заголовок: «Не можем создать смартфон», — Nothing отменила выпуск CMF Phone 3 Pro из-за роста цен на память.
