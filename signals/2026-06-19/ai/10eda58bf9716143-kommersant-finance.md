---
title: "Минюст пополнил реестр иноагентов"
date: "2026-06-19"
status: "draft"
signal_type: "fact"
...
sources:
  - "https://www.kommersant.ru/doc/8760422"
source_titles:
  - "Коммерсантъ: Минюст пополнил реестр иноагентов"
source_types:
  - "Деловое медиа"
media:
  - "https://www.kommersant.ru/doc/8760422"
...
Сигнал попал в поток «AI — железо, софт и исследования» и может быть полезен для тематического дайджеста.

## Факты

- Источник: Коммерсантъ.
- Дата в ленте: 2026-06-19.
- Заголовок: Минюст пополнил реестр иноагентов.
